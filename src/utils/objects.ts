...
export const boxContent = [
	{
		icon: {
			component: Icon,
			props: {
				classAttr: "w-10 h-10 text-white",
				svgData:
					"M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z",
			},
		},
		backdropImage: "/19631ca3efe9444cb0d08c8fdbdaa48a.jpeg",
		content: "UI/UX Deigner",
		description: "27 Projects completed",
	},

	{
		...
		description: "Full stack - 34 projects completed",
	},

	{
		...
		description: "22 Projects completed",
	},
...
export const educationObj = [
	{
		...
		description:
			"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam cumque ut et ducimus cupiditate reprehenderit quam vero explicabo amet doloremque at delectus, accusamus natus magnam eum impedit molestias nemo voluptas.",
	},
	{
		index: 1,
		title: "Group Scolaire Officiel de Butare",
		time: "2018 - 2022",
...
export const services = [
	{
		title: "Web Design",
		icon: "/icon-design.d6326a90fb3a6e270b2fbf68c58759cb.svg",
		decscription:
	...
	},
	{
		...
		icon: "/icon-dev.2a51ebae3899ae5ab67adf9875f02393.svg",
		decscription:
			"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet, molestiae. Consequatur laboriosam incidunt inventore tempore, itaque repellendus. ",
	},
	{
		title: "Mobile apps",
		icon: "/icon-app.db860430683b57c1968ad231a13af0bf.svg",
		decscription:
			"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet, molestiae. Consequatur laboriosam incidunt inventore tempore, itaque repellendus. ",
	},
	{
		title: "Desktop apps",
		icon: "/icons8-desktop-50.png",
		decscription:
			"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet, molestiae. Consequatur laboriosam incidunt inventore tempore, itaque repellendus. ",
	},
];
